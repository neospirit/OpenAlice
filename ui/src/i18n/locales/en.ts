...
export const en = {
  ...
  createWorkspace: {
    ...
    tagLabel: 'Tag',
    toolsLabel: 'Tools',
    toolsCli: 'CLI — data tools via the alice*/traderhub commands on PATH (default)',
    toolsMcp: 'MCP — data tools as MCP servers',
    toolsHint: "How the agent reaches Alice's data tools. Applies to tool-injecting workspaces.",
    cancel: 'Cancel',
    creating: 'Creating…',
