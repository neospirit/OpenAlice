...
export const en = {
  ...
  firstRunGuide: {
    ...
    action: {
      ...
      continueWithoutUTA: 'Continue without UTA',
    ...
    broker: {
      ...
      panelBodyNeedsUTA: 'The broker-connected options need a connector first. Connect one now, or continue without UTA and add it later.',
    ...
    error: {
      ...
      continueWithoutUTA: 'Failed to continue without UTA',
    },
  },
  theme: {
