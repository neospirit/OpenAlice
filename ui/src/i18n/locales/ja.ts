...
export const ja: Resources = {
  ...
  createWorkspace: {
    ...
    tagLabel: 'Tag',
    toolsLabel: 'ツール',
    toolsCli: 'CLI — PATH 上の alice*/traderhub コマンドでデータツールにアクセス（デフォルト）',
    toolsMcp: 'MCP — データツールを MCP server として提供',
    toolsHint: 'エージェントが Alice のデータツールに到達する方法。ツールを注入するワークスペースにのみ適用されます。',
    cancel: 'キャンセル',
    creating: '作成中…',
    create: 'ワークスペースを作成',
  },
